        ...
        <div class="col-4 bg-white py-3 my-3">
            ...
            <div style="background-color: white">
                <div class="mb-5 order-bottom">
                    <a href="Home.jsp"><img src="../img/logo.jpg" class="img6 trans1 b" alt=""></a>

                </div>
				
                <div style="margin-left: 150px;margin-top: 150px">
                    <p>Hesabinizi Olusturun <br> Hesabiniz Var Mi?<a href="kullaniciGiris.jsp" class="ab ml-1" style="color: #985634">Giris Yapin</a></p>
