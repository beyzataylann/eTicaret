<%@ page language="java" import="Controller.kullaniciController,model.kullaniciModel" contentType="text/html; charset=ISO-8859-1"
       ...
       <%@ include file="HesapAyarlari.jsp" %>
        ...
        <div class="col-4 ">
            ...
            <form class="needs-validation" action="bilgiControl.jsp" novalidate>
                ...
                <button class="btn bg-secondary btn-lg btn-block mt-5 ml-4 mb-4" type="submit" style="color: white">G�ncelle</button>
            </form>
