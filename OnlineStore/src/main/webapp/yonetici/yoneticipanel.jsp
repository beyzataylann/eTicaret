...
<body>
    ...
    <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example mt-3">
	        ...
	        <%@ include file="../yonetici/musteriler.jsp" %>
			<%@ include file="../yonetici/kategoriler.jsp" %>
			<%@ include file="../yonetici/yoneticiUrun.jsp" %>
			<%@ include file="../yonetici/yoneticiSiparisler.jsp" %>
			<%@ include file="../yonetici/yoneticiler.jsp" %>	
